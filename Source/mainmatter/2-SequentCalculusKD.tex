...
\calculusName{2SC}         % The name of the calculus
\calculusAcronym{}          % The acronym if defined above, or empty otherwise. 
\calculusLogic{KD}        % Specify the logic (e.g. Classical Logic, Intuitionistic Logic, ...) for which this calculus is intended.
\calculusLogicOrder{Modal Propositional}   % Specify the order of the logic (e.g. Propositional, Quantified Propositional, First-Order, Higher-Order, ...).
\calculusType{2-Sequent Calculus}         % Specify the calculus type (e.g. Tableau, Sequent Calculus, Hyper-Sequent Calculus, Natural Deduction, ...)
\calculusYear{1992}         % The year when the calculus was published.

\calculusAuthor{Andrea Masini}       % The name(s) of the author(s) of the calculus.
...
\entryTitle{2-Sequent Calculus for KD}     % Title of the entry (usually coincides with the name of the calculus).
\entryAuthor{Tim Lyon}     
...
\begin{entry}{2-SequentCalculusKD}  
